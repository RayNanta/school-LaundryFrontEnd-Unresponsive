  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/edit_member" exact element={<MemberEdit/>} /> 
        <Route path="/tambah_outlet" exact element={<OutletTambah/>} /> 
        <Route path="/edit_outlet" exact element={<OutletEdit/>} /> 
        <Route path="/tambah_user" exact element={<UserTambah/>} /> 
        <Route path="/edit_user" exact element={<UserEdit/>} /> 
        <Route path="/tambah_paket" exact element={<PaketTambah/>} /> 
        <Route path="/edit_paket" exact element={<PaketEdit/>} /> 
        <Route path="/detail_transaksi" exact element={<TransaksiDetail/>} /> 
        <Route path="/tambah_transaksi" exact element={<TransaksiTambah/>} /> 
        <Route path="/pilih_transaksi" exact element={<TransaksiPilih/>} /> 
        <Route path="/konfirmasi_transaksi" exact element={<TransaksiKonfirmasi/>} /> 
        <Route path="/konfirmasi_pilih_transaksi" exact element={<TransaksiPilihKonfirmasi/>} /> 
      </Routes>
    </Router>
  );
}
