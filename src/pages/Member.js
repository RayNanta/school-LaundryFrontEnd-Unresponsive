                    ...
                    <tbody>
                        <tr className=' border-b-2 border-gray-200 text-left hover:bg-gray-100 duration-300'>
                            ...
                            <td className='p-5 flex'>
                                <div>
                                    <Link className='border-2 border-gray-200 py-3 px-5 text-black rounded-lg hover:bg-blue hover:text-white  duration-300 font-semibold' to='/edit_member'>Edit</Link>
                                </div>
                                <div>
                                    <Link className='border-2 border-gray-200 py-3 px-5 ml-5 text-black rounded-lg hover:bg-red hover:text-white  duration-300 font-semibold' to='/tammbah-member'>Hapus</Link>
                                </div>
                            </td>
                        </tr>
                        <tr className=' border-b-2 border-gray-200 text-left hover:bg-gray-100 duration-300'>
